        ...
        <>
          {movies?.pages.reduce(
            ...
            <div className="flex flex-col items-center mb-12">
              <div>Erro</div>
              <p className="text-3xl mt-5"> Não existe esse Filme </p>
            </div>
          ) : (
            <InfiniteScroll
              ...
              loader={<div>Carregando mais</div>}
              endMessage={<></>}
            >
      ...
      {currentTab === "tv" && (
        <>
          {tvs?.pages.reduce(
            ...
            <div className="flex flex-col items-center mb-12">
              <div>Error</div>
              <p className="text-3xl mt-5"> Não existe essa Serie</p>
            </div>
          ) : (
            <InfiniteScroll
      ...
      {currentTab === "anime" && (
        <>
          {animes?.pages.reduce(
            ...
            <div className="flex flex-col items-center mb-12">
              <div>Error</div>
              <p className="text-3xl mt-5"> Não existe esse Anime</p>
            </div>
          ) : (
            <InfiniteScroll
