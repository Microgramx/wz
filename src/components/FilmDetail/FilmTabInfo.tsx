      ...
      <div className="mt-10 text-lg">
        {currentTab === "overall" && (
          <>
            ...
            <p className="text-white mb-3 font-medium"> HISTÓRIA</p>
            {detail && (
            ...
            <p className="text-white font-medium mt-8 mb-3">DETALHES</p>
            {!detail && (
              <>
            ...
            {detail && (
              <>
                ...
                {detail.media_type === "movie" && (
                  <p>Data Lançamento: {(detail as DetailMovie).release_date}</p>
                )}
                {detail.media_type === "tv" && (
                  <p>Última data de exibição: {(detail as DetailTV).last_air_date}</p>
                )}
                <p>
                  Idioma falado:
                 ...
                 <li key={cast.id} className="flex gap-3 items-center">
                   ...
                   <div className="flex-grow">
                     ...
                     <p className="text-white text-base">
                       <span className="italic">é </span> {cast.character}
                     </p>
                   </div>
                 </li>
               ))}
