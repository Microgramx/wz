            ...
            >
              <div className="bg-gradient-to-br from-transparent to-black/80 h-full rounded-bl-2xl">
                <div className="flex flex-col md:flex-row bottom-[-85%] md:bottom-[-20%]  items-start absolute left-1/2 -translate-x-1/2  w-full max-w-[1000px]">
                  ...
                  <Link
                    to="watch2"
                    className="flex gap-6 items-center pl-6 pr-12 py-3 rounded-full bg-primary text-white hover:bg-red-800 transition duration-300 mt-24 ml-6"
                  >
                    <BsPlay size={25} />
                    <span className="text-lg font-medium">WATCH 2</span>
                  </Link>
                </div>
