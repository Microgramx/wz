...
const Home: FC = () => {
  ...
  return (
    <>
      <Title value="WZTuga - Filmes & Series HD Legendado" />
      ...
      <div className="flex items-start">
        ...
        <div className="flex-grow pt-0 pb-7 border-x md:px-[2vw] px-[4vw] md:border-dark min-h-screen">
          {/* TAB */}
          <div className="flex justify-between items- md:items-start">
            {/* Button Div */}
            <div className="inline-flex gap-[40px] relative pb-3 mt-2 md:mt-4 text-gray-400">
              <button
                ...
                style={{
                  // Adicione aqui estilos adicionais, como cores de fundo e borda
                  background: currentTab === "movie" ? "#333" : "transparent",
                  border: "none",
                  borderRadius: "5px",
                  padding: "10px 20px",
                  outline: "none", // Remova a borda ao clicar
                }}
              >
                Filmes
              </button>
