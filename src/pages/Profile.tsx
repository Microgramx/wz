      ...
      <div className="flex  md:flex-row flex-col item-start gap-4  mr-4">
        ...
        <div className="flex-grow">
          <div className=" rounded-md   md:h-[90%] p-[40px]  w-[100%] md:w-[90%]   md:ml-0  -ml-8">
            <p className="text-lg font-bold pb-4"> Informaçoes </p>
            <p>

Caro utilizador,

Gostaríamos de apresentar este site como um sistema construído em React, a nova e promissora linguagem da web. Este sistema é totalmente automatizado, operando exclusivamente com APIs. A equipe não precisa mais se preocupar em atualizar os filmes, pois todo o processo é automatizado.

É importante ressaltar que utilizamos as mais recentes linguagens de programação para oferecer a melhor experiência possível aos nossos utilizadores. Como tal, a equipe tem o foco exclusivo no desenvolvimento do front-end e em melhorias visuais, sem a necessidade de intervir no conteúdo em si.

Além disso, é digno de nota que a flexibilidade e capacidade do React permitem que o nosso sistema seja compatível com a nova era de tecnologias emergentes, como a realidade virtual (VR), realidade aumentada (AR), dispositivos móveis e o Apple Vision Pro. Isso ocorre devido à sua natureza de funcionamento como um aplicativo em vez de um site tradicional.

No entanto, é importante mencionar que muitos conteúdos podem não ter servidores disponíveis devido à ampla gama de filmes e séries presentes no TheMovieDatabase em comparação com a disponibilidade de links de conteúdo na internet. Isso é algo que não podemos controlar, mas estamos comprometidos em oferecer a melhor experiência possível aos nossos utilizadores.

Estamos à disposição para qualquer esclarecimento adicional que necessite. Obrigado pela sua confiança e apoio contínuo.

Atenciosamente,
Equipe Warez
            </p>
            <p>
              Se fez o login com o Google não precisas alterar a senha nem o email!
            </p>
